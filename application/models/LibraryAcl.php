...
class Application_Model_LibraryAcl extends Zend_Acl
{
    ...
    public function __construct()
    {
        ...
        $this->allow('user', 'account', array('index', 'edit', 'editpassword', 'avatar', 'logout', 'favorites', 'removefavorite'));
        $this->allow('user', 'shop', array('index', 'new', 'modification', 'media', 'public', 'my','delete'));
